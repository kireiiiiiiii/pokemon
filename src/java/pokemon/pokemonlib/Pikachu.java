...
public class Pikachu extends Pokemon {
    ...
    public static String image = saveImage(imageArray);
    private static String element = "Electric";
    private static String type = "Pikachu";
    private static int maxHp = 60;
    private static String[] stageType = { "Raichu" };
    private static String[] abilities = { "Lightning rod", "Thunder" };
    private static String colour = "\u001b[43m"; // yellow

    public Pikachu(String name, int currHp) {
